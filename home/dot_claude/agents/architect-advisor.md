...
description: Senior architect for system design, architectural trade-offs, and technology choices. Use when the decision shapes structure rather than implementation.
model: opus
color: purple
---
