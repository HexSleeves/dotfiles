...
3. **Identify Specialist Agents Needed**
   ...
   - `quality-guardian` - Code review, security, testing, plan validation
...
|-----------|--------------|-------------------|
| Architecture Design | architect-advisor | research |
| Code Quality/Review | quality-guardian | refactor-planner |
