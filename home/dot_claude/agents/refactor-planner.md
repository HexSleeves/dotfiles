...
description: Analyze code structure and produce a step-by-step refactoring plan with risk assessment. Use when the user wants a plan before any refactor is executed.
color: purple
---
