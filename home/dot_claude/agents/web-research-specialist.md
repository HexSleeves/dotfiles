...
description: Research a technical question or bug across community sources — GitHub issues, Stack Overflow, Reddit, forums. Use when the answer likely lives in someone else's thread rather than in docs.
model: sonnet
color: blue
---
