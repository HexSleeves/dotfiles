...
§
Default IDE: Cursor. Uses zsh config at ~/.config/zsh/conf.d/ with modular setup. Shell: zsh on macOS, fish on Linux VM. Has Cap CLI at /Users/lecoqjacob/.cap/bin.